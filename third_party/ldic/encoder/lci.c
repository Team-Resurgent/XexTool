...
#define DEFAULT_FILE_XLAT_SIZE 0
...

{
    ...
    *pmchHandle = (LCI_CONTEXT_HANDLE) 0;   /* wait until it's valid */
    ...
    context = (PMCC_CONTEXT)pfnma(sizeof(struct LCI_CONTEXT));
	...
	context->encoder_context = (t_encoder_context*)pfnma(sizeof(*context->encoder_context));
